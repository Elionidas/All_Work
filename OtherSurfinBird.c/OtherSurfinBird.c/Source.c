...
struct TotallyValidStructUse
	{
		char *Input_String[1024];
		char *Input_Search[256];
		char *Expected_Return[256];
...
//	printf("The length of the test array is: %d \n", sizeof(testInputArray)/sizeof(testInputArray[0])); // DEBUGGING
	...
	//heheheh array of totally valid structs
	//normal input
	struct TotallyValidStructUse InputTest0[] = { testInput0, testKey0, testInput0[29], ERROR_CODE_SUCCESS }; //done
	struct TotallyValidStructUse InputTest1[] = { testInput1, testKey1, testInput1[21], ERROR_CODE_SUCCESS }; //done

	//two occurences of searchword
	struct TotallyValidStructUse InputTest2[] = { testInput3, testKey3, testInput3[2], ERROR_CODE_SUCCESS }; //done
	struct TotallyValidStructUse InputTest3[] = { testInput4, testKey4, testInput4[10], ERROR_CODE_SUCCESS }; //done

	//sentence_ptr is null -starts at test 7 i think-
	struct TotallyValidStructUse InputTest4[] = { testInput7, testInput7, testInput7, ERROR_NULL_SENTENCE_POINTER };
	struct TotallyValidStructUse InputTest5[] = { testInput8, testInput8, testInput8, ERROR_NULL_SENTENCE_POINTER };

	//error_code is null
	struct TotallyValidStructUse InputTest6[] = { testInput11, testKey11, NULL, ERROR_NULL_SEARCH_POINTER };
	struct TotallyValidStructUse InputTest7[] = { testInput12, testKey12, NULL, DEFAULT_ERROR_CODE };

	//no occurences of searchword
	struct TotallyValidStructUse InputTest8[] = { testInput7, NULL, testInput0[29], ERROR_CODE_SUCCESS };
	struct TotallyValidStructUse InputTest9[] = { testInput8, NULL, testInput0[29], ERROR_CODE_SUCCESS };

	struct TotallyValidStructUse *TestArray[] = {InputTest0, InputTest1, InputTest2, InputTest3, InputTest4, InputTest5, InputTest6, InputTest7, InputTest8, InputTest9};
	...
	for (i = 0; i < numTotalTests; i++)
	{
		...
		printf("* TEST #%02d *\n", i);
		printf("************\n");
		tempReturnValue_ptr = find_the_word((TestArray[i] -> Input_String), (TestArray[i] -> Input_Search), (TestArray[i] -> Expected_Error));
...
//im gonna take the teacher version of this performace lab, build a struct, and use that to pass the function data
