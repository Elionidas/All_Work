...
string weaponR2 = "  O==========E>>>                 ";
string weaponR3 = "            /          ";
string weaponName = "Rusty metal probe";
int weaponDamage = 10;

std::string task1 = "1. Progress through level 1";
std::string task2 = "2. Kill Space spiders.";
std::string task3 = "3. Probe ship commander.";
...
void map(char left, char center, char right, char LR, char CR, char RR, char L, char R, std::string text1, std::string text2, char lastDir)
{
	...
	*/
	...
	printGold(1);
	std::cout << "             _________________________________________         " << task3 << "      " << std::endl;
	std::cout << "______________________________________/_________________________________________\\______________________________________" << std::endl;
...
inline void map(char left, char center, char right, char LR, char CR, char RR, std::string text1, std::string text2, char lastDir)
{
}
